...
$indexablePosts = [
    ...
    'content-marketing-ideas-b2b-india',
    'instagram-reels-ideas-local-businesses',
    'ecommerce-product-page-seo-checklist',
    'reduce-cost-per-lead-google-ads',
    'website-speed-optimization-small-business',
    'local-seo-solapur-businesses',
    'digital-marketing-strategy-startups-pune',
    'b2b-lead-generation-industrial-companies',
    'ai-tools-digital-marketing-agencies',
    'ai-tools-content-writing-workflow',
    'ai-tools-social-media-managers',
    'ai-tools-seo-research-content-planning',
    'ai-tools-customer-support-small-business',
    'ai-tools-sales-lead-generation',
    'ai-tools-website-design-content-planning',
];
